...
from losses import reconstruct_precip_mm, reconstruct_temperature, wet_day_loss
    ...
    if args.lambda_recon > 0 or args.lambda_wet > 0:
        ...
        if args.lambda_wet > 0 and args.target_type == "precipitation":
            pred_mm, _ = reconstruct_precip_mm(
                x_gnn, residual_hat, log_clip=args.aux_log_clip
            )
            ...
            pred_value, _ = reconstruct_temperature(x_gnn, residual_hat)
