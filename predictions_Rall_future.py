...
if __name__ == '__main__':
    ...
    if args.test_idxs_file == "":
        ...
        train_idxs, val_idxs = derive_train_val_idxs_new(2080, 1, 1, 2099, 11,
                         30, 2080, args.model_name, idxs_not_all_nan=None, validation_year=2085, args=None, accelerator=accelerator)
