...
class GNN4CD_model_NOREG(nn.Module):
    ...
    def __init__(self, encoding_dim=128, seq_l=25, h_in=5*5, h_hid=5*5, n_layers=2, high_in=6+1, low2high_out=64, high_out=64):
        ...
        self.processor = geometric_nn.Sequential('x, edge_index', [
            ...
            (GATv2Conv(in_channels=low2high_out, out_channels=high_out, heads=2, dropout=0.0, aggr='mean', add_self_loops=True, bias=True), 'x, edge_index -> x'),
